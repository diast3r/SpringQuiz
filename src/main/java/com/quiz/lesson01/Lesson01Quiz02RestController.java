...
public class Lesson01Quiz02RestController {
	...
	public List<Board> quiz02_2() {
		// @ResponseBody + return String => HttpMessageConverter 클래스 => HTML로 변환
		// @ResponseBody + return 객체 => HttpMessageConverter 클래스 => Jackson 라이브러리 => JSON으로 변환
	...
	public ResponseEntity<Board> quiz03_3() {
		...
		// return new ResponseEntity<>(board, HttpStatusCode.valueOf(500));
	}
